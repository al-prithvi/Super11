(function() {
    ...
    window.tableau._apiLoaded || (window.tableau._apiLoaded = !0, function() {
        ...
        function o(n, t) {
            var i;
            return u(n) ? t : (i = n.match(/^(yes|y|true|t|1)$/i), !u(i))
        }

        function ot(n) {
            var t, i, r = [];
            if (u(n.filter)) return "";
            for (t = 0, i = n.filter.length; t < i; t++) r.push("&" + n.filter[t]);
            return r.join("")
        }
        ...
        function ht(n, t, i) {
            ...
            for (e in i) i.hasOwnProperty(e) && o[e] === undefined && r.push("&:" + e + "=" + i[e]);
            return r.join("")
        }
        ...
        function v(n, t) {
            var i, h = n.childNodes,
                s, c, r, f, e = "",
                l;
            for (t = t || {}, s = 0, c = h.length; s < c; s++) i = h[s], g(i, "param") && i.name ? (r = i.name, f = i.value ? i.value : null, r === "name" ? e = f : r === "filter" ? (t.filter = t.filter || [], t.filter.push(f)) : (t[r] = f, r === "mobile" && o(f, !1) && (w = !0))) : i.childNodes && i.childNodes.length > 0 && !g(i, "object") && (l = v(i, t), e = u(e) ? l : e);
            return e
        }

        function tt(n) {
            var r, i, t, f;
            return t = u(n.host_url) ? u(n.serverRoot) ? tableau._apiScripts[0] : n.serverRoot : decodeURIComponent(n.host_url), r = new RegExp(".*//"), f = new RegExp("https?://[-A-Za-z0-9]*public[-A-Za-z0-9]*\\.tableau"), i = r.exec(window.location.href) && r.exec(window.location.href)[0], i && i.indexOf("file://") === -1 && t.indexOf(i) === -1 && t.match(f) !== null && (t = t.replace(r, i)), t
        }
        ...
        function vt() {
            var n, t;
            return n = at(), n ? n : (n = l(document.documentElement), t = document.compatMode === "BackCompat", t && (n.height = document.body.clientHeight - n.left, n.width = document.body.clientWidth - n.top), n.left += b(), n.top += k(), n)
        }

        function yt(n) {
            for (var r, u, i = l(n), t = n.parentElement; t && t.parentElement; t = t.parentElement) r = f(t).overflow, (r === "auto" || r === "scroll" || r === "hidden") && (i = it(i, l(t)));
            return u = vt(), it(i, u)
        }
        ...
        function h(n) {
            var i, u;
            n === t && (u = t + 1, i = tableau.vizs[r[u]], i && (t = u, i.load(), window.postMessage && setTimeout(function() {
                h(t)
            }, 3e3)))
        }
        ...
        function bt() {
            var n;
            p ? (n = tableau.vizs[r[t]], n && n._iframe.readyState === "complete" && (y(t), h(t))) : (y(t), h(t))
        }
            ...
            if (n.data && (typeof n.data == "string" || n.data instanceof String))
                if (o = n.data.split(","), f = o[0], f === "tableau.completed" || f === "completed") {
                    if (e = parseInt(o[1], 10), isNaN(e))
                        for (u = 0; u <= t; u++) i = tableau.vizs[r[u]], i && i._hideLoadIndicators();
                    y(e);
                    h(e)
                } else if (f === "tableau.loadIndicatorsLoaded") i = tableau.vizs[r[t]], i && i._hideLoadIndicators();
            else if (f === "layoutInfoReq")
                for (u = 0; u <= t; u++) i = tableau.vizs[r[u]], i && i._sendVisibleRect();
            else f === "tableau.listening" ? (i = tableau.vizs[r[t]], i && i._enableVisibleRectCommunication()) : f === "tableau.staticImageRedirect" && (e = parseInt(o[1], 10), i = e > -1 ? tableau.vizs[r[e]] : null, i && i._hideLoadIndicators())
        }
        ...
        function s() {
            var n, o, e, s, i, c, u = [];
            if (s = gt(), s.length !== 0) {
                for (ti(), n = 0, o = s.length; n < o; n++) e = s[n], i = {
                    filter: [],
                    ticket: "",
                    path: ""
                }, c = v(e, i), i.width = parseInt(f(e, null).width, 10), isNaN(i.width) && delete i.width, i.height = parseInt(f(e, null).height, 10), isNaN(i.height) && delete i.height, u.push({
                    name: c,
                    objectElement: e,
                    params: i
                });
                for (ni(u), n = 0, o = u.length; n < o; n++) tableau.createViz(u[n].name, u[n].objectElement, u[n].params);
                r.sort(pt);
                h(t)
            }
        }
        ...
        window.tableau.Viz.prototype._sendVisibleRect = function() {
            var n, t, i;
            d() && this._iframe && this._iframe.contentWindow && (n = yt(this._iframe), t = l(this._iframe), i = ["layoutInfoResp", n.left - t.left, n.top - t.top, n.width, n.height].join(","), this._iframe.contentWindow.postMessage(i, "*"))
        };
